...
def pricd(a, t, s):
    ...
    if c == "1100":
        ...
        s = encrypt(a + moveTo(a.substring(2, 3) + t) + s).upper()
        ...
        s = encrypt(encrypt(a) + moveTo(c) + moveTo(s.substring(10, 15))).upper()
...
if __name__=="__main__":
    print(prijm("011001900311","26540678","20190708","316342","2019-08-30 14:29:48","ek","05EEA095BA29535C6CEDC47059A771F7"))